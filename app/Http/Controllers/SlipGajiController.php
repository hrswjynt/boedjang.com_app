                ...
                FROM
                    ...
                    FROM
                        ...
                        SELECT
                            ...
                            ifnull(( SELECT sum(total) FROM u1127775_absensi.Abs_angsuran WHERE u1127775_absensi.Abs_angsuran.nip = b.NIP and u1127775_absensi.Abs_angsuran.tanggal BETWEEN '".$date1."' AND '".$date2."'),'0') AS 'Angsuran',
