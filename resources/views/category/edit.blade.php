...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kategori SOP</h1>
    </div>
    <!-- Content Row -->
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="{{ route('category.index') }}" class="btn btn-info btn-sm add">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="POST" action="{{route('category.update',$category->id)}}" id="category_form">
                        @csrf
                        @method('PUT')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-4 bmd-form-group">
                                                            <label class="bmd-label-floating">Nama Kategori <span class="red">*</span></label>
                                                            <input name="name" type="text"
                                                                class="form-control" value="{{$category->name}}" id="name" maxlength="100" >
                                                        </div>
                                                        <div class="form-group mb-4 bmd-form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan mengupdate data kategori?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Perubahan Data Kategori Dibatalkan!", {
                  icon: "error",
                });
              }
            });
