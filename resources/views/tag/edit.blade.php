        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6><b>Edit Tag</b></h6>
                    <a href="{{ route('tag.index') }}" class="btn btn-info btn-sm add">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="POST" action="{{route('tag.update',$tag->id)}}" id="tag_form">
                        @csrf
                        @method('PUT')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-4 bmd-form-group">
                                                            <label class="bmd-label-floating">Nama Tag <span class="red">*</span></label>
                                                            <input name="name" type="text"
                                                                class="form-control" value="{{$tag->name}}" id="name" maxlength="100" >
                                                        </div>
                                                        <div class="form-group mb-4 bmd-form-group">
                                                            <label class="bmd-label-floating">Deskripsi<span class="red">*</span></label>
                                                            <input name="description" type="text"
                                                                class="form-control" value="{{$tag->description}}" id="description" maxlength="200" @if(Auth::user()->role !== 1) readonly @endif>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan mengupdate data tag?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Perubahan Data Tag Dibatalkan!", {
                  icon: "error",
                });
              }
            });
