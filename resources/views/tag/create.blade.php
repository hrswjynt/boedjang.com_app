        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="POST" action="{{route('tag.store')}}" id="tag_form">
                        @csrf
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan menambah data tag?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Penambahan Data Tag Dibatalkan!", {
                  icon: "error",
                });
              }
            });
