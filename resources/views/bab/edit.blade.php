        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="POST" action="{{route('bab.update',$bab->id)}}" id="bab_form">
                        @csrf
                        @method('PUT')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-4 bmd-form-group">
                                                            ...
                                                            <input name="name" type="text"
                                                                class="form-control" value="{{$bab->name}}" id="name" maxlength="100" required="">
                                                        </div>
                                                        <div class="form-group mb-4 bmd-form-group">
                                                            <label class="bmd-label-floating">Urutan <span class="red">*</span></label>
                                                            <input name="sequence" type="number"
                                                                class="form-control" value="{{$bab->sequence}}" id="sequence" required="">
                                                        </div>
                                                        <div class="form-group mb-4 bmd-form-group">
                                                            <label class="bmd-label-floating">Deskripsi<span class="red">*</span></label>
                                                            <input name="description" type="text"
                                                                class="form-control" value="{{$bab->description}}" id="description" maxlength="200" @if(Auth::user()->role !== 1) readonly @endif>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
