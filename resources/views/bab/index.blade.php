                ...
                <div class="card-body">
                  ...
                  <div id="bab-data">
                    <div class="table-responsive">
                        <table class="table" id="table-bab-data" width="100%">
                            <thead>
                                <tr>
                                    <th width="1%">
                                        No
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("body").on("click", ".babDelete", function (e) {
            e.preventDefault();
            var id = $(this).data("id");
            ...
            swal({
                ...
                text: 'Bab yang telah dihapus tidak dapat dikembalikan lagi!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function (value) {
                if (value) {
