        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="POST" action="{{route('normcategory.update',$normcategory->id)}}" id="normcategory_form">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-4 bmd-form-group">
                                        ...
                                        <input name="name" type="text"
                                            class="form-control" value="{{$normcategory->name}}" id="name" maxlength="100" >
                                    </div>
                                    <div class="form-group mb-4 bmd-form-group">
                                        <label class="bmd-label-floating">Deskripsi<span class="red">*</span></label>
                                        <input name="description" type="text"
                                            class="form-control" value="{{$normcategory->description}}" id="description" maxlength="200" @if(Auth::user()->role !== 1) readonly @endif>
                                    </div>
                                </div>           
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan mengupdate data Kategori Norm?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Perubahan Data Kategori Norm Dibatalkan!", {
                  icon: "error",
                });
              }
            });
