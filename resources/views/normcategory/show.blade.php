        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6><b>Detail Kategori Norm</b></h6>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-4 bmd-form-group">
                                    ...
                                    <input name="name" type="text"
                                        class="form-control" value="{{$normcategory->name}}" id="name" maxlength="100" disabled="">
                                </div>
                                <div class="form-group mb-4 bmd-form-group">
                                    <label class="bmd-label-floating">Deskripsi <span class="red">*</span></label>
                                    <input name="description" type="text"
                                        class="form-control" value="{{$normcategory->description}}" id="description" maxlength="200" disabled="">
                                </div>
                            </div>
                        </div>
                    </div>
