        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="POST" action="{{route('brand.update',$brand->id)}}" id="brand_form">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-4 bmd-form-group">
                                        ...
                                        <input name="name" type="text"
                                            class="form-control" value="{{$brand->name}}" id="name" maxlength="100" >
                                    </div>
                                    <div class="form-group mb-4 bmd-form-group">
                                        <label class="bmd-label-floating">Deskripsi<span class="red">*</span></label>
                                        <input name="description" type="text"
                                            class="form-control" value="{{$brand->description}}" id="description" maxlength="200" @if(Auth::user()->role !== 1) readonly @endif>
                                    </div>
                                </div>           
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan mengupdate data Brand?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Perubahan Data Brand Dibatalkan!", {
                  icon: "error",
                });
              }
            });
