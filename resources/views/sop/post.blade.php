            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <iframe width="480" height="360" src="https://www.youtube.com/embed/{{$sop->youtube}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        @endif
                        <div class="col-md-12">
                            <br><br><br><br>
                            <br><br><br><br>
