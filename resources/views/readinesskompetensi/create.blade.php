            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6><b>Tambah Kompetensi Readiness</b></h6>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('readinesskompetensi.store') }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btn-submit").click(function() {
                swal({
                        title: "Apakah anda yakin akan menambah data kompetensi readiness?",
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            swal("Proses Penambahan Data Kompetensi Readiness Dibatalkan!", {
                                icon: "error",
                            });
                        }
                    });
