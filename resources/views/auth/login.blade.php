                ...
                <div class="card o-hidden border-0 shadow-lg my-4">
                    <div class="card-body p-0">
                        ...
                        <div class="row p-3 bg-gray-800">
                            <div class="text-center col-lg-12 m_small">
                                ...
                                <div class="p-3">
                                    <div class="text-center">
                                        ...
                                        <img class="img img-responsive"
                                            src="{{ asset('landing/assets/img/boedjang.png') }}" height="150px"
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('username') is-invalid @enderror form-control-user"
                                                id="exampleInputEmail" name="username" value="{{ old('username') }}"
                                                aria-describedby="NIP" placeholder="NIP" required
                        ...
                        <div class="row bg-gray-800" style="margin: 0 auto;">
                            <div class="text-center col-lg-6 p-3 desktop" style="margin-top: 20px;color: white">
