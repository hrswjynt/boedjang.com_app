										...
										<div class="container-fluid mt-3">
											<div class="row">
												...
												<div class="col-12 p-2">
													<input type="text" class="form-control mb-3" value="{{ $matrixHeader->dataAtasan->nama_absen }}"
														readonly>
												</div>
												...
												<div class="col-12 p-2">
													<input type="text" class="form-control mb-3" value="{{ $matrixHeader->catatan }}" readonly>
												</div>
															...
															<tbody>
																@foreach ($matrixHeader->matrix as $i => $matrix)
																	<tr>
																		...
																		<td>
																			<input type="checkbox" name="atasan[]" value="{{ $matrix->id }}"
