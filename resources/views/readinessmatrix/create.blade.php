								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-4 bmd-form-group">
											...
											<select id="atasan" class="form-control select2" name="atasan" style="width: 100%">
										...
										<div class="form-group mb-4 bmd-form-group">
											...
											<select id="readiness_kategori" class="form-control select2" name="readiness_kategori" style="width: 100%">
											</select>
										</div>
										<div class="form-group mb-4 bmd-form-group">
											<label class="bmd-label-floating">Jenis <span class="red">*</span></label>
											<select id="readiness_jenis" class="form-control select2" name="readiness_jenis" style="width: 100%">
											</select>
										</div>
										<div class="form-group mb-4 bmd-form-group">
											<label class="bmd-label-floating">Bagian <span class="red">*</span></label>
											<select id="readiness_bagian" class="form-control select2" name="readiness_bagian" style="width: 100%">
											</select>
										</div>
									</div>
