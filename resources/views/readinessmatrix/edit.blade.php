			...
			<div class="col-md-12">
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						...
						@endif
						<form method="POST" action="{{ route('readinessmatrix.update', $matrixHeader->id) }}" id="readinessmatrix_form">
							@csrf
							@method('PUT')
							<div class="container-fluid mt-3">
								<div class="row">
									...
									<div class="col-9">
										<input type="text" class="form-control mb-3" value="{{ $matrixHeader->dataAtasan->nama_absen }}" readonly>
									</div>
												...
												<tbody>
													@foreach ($matrixHeader->matrix as $i => $matrix)
														<tr>
															...
															<td>
																<input type="checkbox" name="kompetensi[]" value="{{ $matrix->id }}"
																	@if ($matrix->staff_valid) checked @endif @if ($matrix->atasan_valid_date) disabled @endif>
															</td>
														</tr>
													@endforeach
												</tbody>
