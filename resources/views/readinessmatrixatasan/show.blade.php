						...
						<form method="POST" action="{{ route('readinessmatrixatasan.update', $matrixHeader->id) }}"
							...
							<div class="container-fluid mt-3">
								<div class="row">
									...
									<div class="col-9">
										<input type="text" class="form-control mb-3" value="{{ $matrixHeader->dataStaff->nama_absen }}" readonly>
									</div>
														...
														<tr>
															...
															<td>
																<input type="checkbox" name="valid[]" value="{{ $matrix->id }}"
																	@if ($matrix->atasan_valid) checked @endif @if (!$matrix->staff_valid_date || $matrix->validator) disabled @endif>
															</td>
														</tr>
													@endforeach
												</tbody>
