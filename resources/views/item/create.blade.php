        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{route('item.store')}}" id="item_form" enctype="multipart/form-data">
                        @csrf
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-4 bmd-form-group">
                                                            ...
                                                            <input name="name" type="text"
                                                                class="form-control" value="{{old('name')}}" tabindex="1" id="name" maxlength="200" >
                                                        </div>
...
<script type="module">
    ...
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan menambah Barang & Bahan?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Penambahan Data Barang & Bahan Dibatalkan!", {
                  icon: "error",
                });
              }
            });
