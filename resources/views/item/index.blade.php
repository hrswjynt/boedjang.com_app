        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6><b>Daftar Barang & Bahan</b></h6>
                    <a href="{{ route('item.create') }}" class="btn btn-success btn-sm add">
                ...
                <div class="card-body">
                  ...
                  <div id="item-data">
                    <div class="table-responsive">
                        <table class="table" id="table-item-data" width="100%">
                            <thead>
                                <tr>
                                    <th>
                                        No
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if(data !== null){
                            return '<a target="__blank" href="'+base_url+'/item-list/'+row.slug+'">'+data+'</a>';
                        }else{
                            return '-';
                        }           
                    }
    ...
    $(document).ready(function () {
        $("body").on("click", ".itemDelete", function (e) {
            ...
            swal({
                ...
                text: 'Barang & Bahan yang telah dihapus tidak dapat dikembalikan lagi!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function (value) {
                if (value) {
