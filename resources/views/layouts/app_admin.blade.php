        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}"
                ...
                <div class="sidebar-brand-icon">
                    ...
                    <img src="{{ asset('landing/assets/img/boedjang.png') }}" class="img img-responsive"
                        style="height: 100px !important;margin:0px !important;">
                </div>
            ...
            <li class="nav-item @if ($page == 'sop_list' || $page == 'norm_list') active @endif">
                ...
                <div id="collapseThree" class="collapse @if ($page == 'sop_list' || $page == 'norm_list') show @endif"
                    aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                        <a class="collapse-item @if ($page == 'sop_list') active @endif"
                            href="{{ route('sop_list.index') }}">SOP</a>
                        @if (Auth::user()->role !== 6)
                            <a class="collapse-item @if ($page == 'norm_list') active @endif"
                                href="{{ route('norm_list.index') }}">Norm</a>
                        @endif
                    </div>
                </div>
            </li>
            ...
            @if (Auth::user()->role !== 6)
                <li class="nav-item @if ($page == 'bukusaku_list' || $page == 'ketentuan_list') active @endif">
                    ...
                    <div id="collapseFour" class="collapse @if ($page == 'bukusaku_list' || $page == 'ketentuan_list') show @endif"
                ...
                @if (Auth::user()->role !== 6)
                    <?php $karyawan = DB::table('u1127775_absensi.Absen')
            ...
            @if (Auth::user()->role == 4)
                ...
                <li class="nav-item @if ($page == 'katalogasset' || $page == 'brand') active @endif">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseUtilities4" aria-expanded="true" aria-controls="collapseUtilities4">
                        <i class="fas fa-cube"></i>
                        <span>Master Aset</span>
                    </a>
                    <div id="collapseUtilities4" class="collapse @if ($page == 'katalogasset' || $page == 'brand') show @endif"
                        aria-labelledby="headingUtilities4" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            @if (Auth::user()->role == 1 || Auth::user()->role == 4)
                                <a class="collapse-item @if ($page == 'brand') active @endif"
                                    href="{{ route('brand.index') }}">Brand</a>
                                <a class="collapse-item @if ($page == 'katalogasset') active @endif"
                                    href="{{ route('asset.index') }}">Katalog Aset</a>
                            @endif
                        </div>
                    </div>
                </li>
            @elseif(Auth::user()->role == 1 || Auth::user()->role == 3)
                ...
                <li class="nav-item @if (
                    $page == 'blog' ||
                        ...
                        $page == 'bpm' ||
                        $page == 'bpmdivision' ||
                        $page == 'bukupedoman') active @endif">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                        <i class="fas fa-cube"></i>
                        <span>Master Data</span>
                    </a>
                    <div id="collapseUtilities" class="collapse @if (
                        $page == 'blog' ||
                            $page == 'user' ||
                            $page == 'tag' ||
                            $page == 'bpm' ||
                            $page == 'bpmdivision' ||
                            $page == 'bukupedoman') show @endif"
                        aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">- Master Data -</h6>
                            @if (Auth::user()->role == 1)
                                <a class="collapse-item @if ($page == 'user') active @endif"
                                    href="{{ route('user.index') }}">Pengguna</a>
                                <a class="collapse-item @if ($page == 'tag') active @endif"
                                    href="{{ route('tag.index') }}">Tag Blog</a>
                                <a class="collapse-item @if ($page == 'blog') active @endif"
                                    href="{{ route('blog.index') }}">Blog</a>
                            @endif
                            <a class="collapse-item @if ($page == 'bpmdivision') active @endif"
                                href="{{ route('bpmdivision.index') }}">BPM Divisi </a>
                            <a class="collapse-item @if ($page == 'bpm') active @endif"
                                href="{{ route('bpm.index') }}">BPM</a>
                            <a class="collapse-item @if ($page == 'bukupedoman') active @endif"
                                href="{{ route('bukupedoman.index') }}">Buku Pedoman</a>
                ...
                <li class="nav-item @if (
                    ...
                    <div id="collapseUtilities2" class="collapse @if (
                        $page == 'sop' ||
                            ...
                            $page == 'history_sop' ||
                            $page == 'norm' ||
                            $page == 'normcategory') show @endif"
                        aria-labelledby="headingUtilities2" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            @if (Auth::user()->role == 1)
                                <h6 class="collapse-header">- Master SOP -</h6>
                                <a class="collapse-item @if ($page == 'history_sop') active @endif"
                                    href="{{ route('sop.history') }}">History Pembaca SOP</a>
                                <a class="collapse-item @if ($page == 'category') active @endif"
                                    href="{{ route('category.index') }}">Kategori SOP</a>
                                <a class="collapse-item @if ($page == 'type') active @endif"
                                    href="{{ route('type.index') }}">Jenis SOP</a>
                                <a class="collapse-item @if ($page == 'jabatan') active @endif"
                                    href="{{ route('jabatan.index') }}">Jabatan SOP</a>
                                <a class="collapse-item @if ($page == 'sop') active @endif"
                                    href="{{ route('sop.index') }}">SOP</a>
                                <h6 class="collapse-header">- Master Norm -</h6>
                                <a class="collapse-item @if ($page == 'norm') active @endif"
                                    href="{{ route('norm.index') }}">Norm</a>
                                <a class="collapse-item @if ($page == 'normcategory') active @endif"
                                    href="{{ route('normcategory.index') }}">Kategori Norm</a>
                            @endif
                        </div>
                    </div>
                </li>
                <li class="nav-item @if ($page == 'bukupedoman' || $page == 'subbab' || $page == 'bab' || $page == 'ketentuan') active @endif">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseUtilities3" aria-expanded="true" aria-controls="collapseUtilities3">
                        <i class="fas fa-cube"></i>
                        <span>Master Rule</span>
                    </a>
                    <div id="collapseUtilities3" class="collapse @if ($page == 'bukupedoman' || $page == 'subbab' || $page == 'bab' || $page == 'ketentuan') show @endif"
                ...
                @if (Auth::user()->role == 1)
                    ...
                    <li class="nav-item @if ($page == 'content' || $page == 'social_media') active @endif">
                        ...
                        <div id="collapseTwo" class="collapse @if ($page == 'content' || $page == 'social_media') show @endif"
                            aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                                <a class="collapse-item @if ($page == 'content') active @endif"
                                    href="{{ route('content.index') }}">Content</a>
                                <a class="collapse-item @if ($page == 'social_media') active @endif"
                                    href="{{ route('socialmedia.index') }}">Social Media</a>
                            </div>
                        </div>
                    </li>
                @endif
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Navbar -->
                    <?php
                    $sop_notif = DB::table('sop_notification')
                        ->leftJoin('sop', 'sop.id', 'sop_notification.sop')
                        ->select('sop_notification.*', 'sop.slug')
                        ->orderBy('date', 'DESC')
                        ->limit(5)
                        ->get();
                    ?>
                                        ...
                                        <a class="dropdown-item d-flex align-items-center"
                                            ...
                                            <div>
                                                ...
                                                <div class="small text-gray-500">
                                                    {{ date_format($datesop, 'D, d-m-Y H:i:s') }}</div>
                                                <span class="font-weight-bold">{{ $notif->keterangan }}</span>
                                            </div>
                                        </a>
                                    @endforeach
                                    <a class="dropdown-item text-center small text-gray-500"
                                        href="{{ route('sop.notification') }}">Lihat Semua</a>
                                </div>
                            </li>
                        @endif
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                @if (Auth::user()->gambar == null)
                                    <img style="border: none;zoom:150%;object-fit: cover;"
                                        class="img-profile rounded-circle shadow"
                                        src="{{ asset('admin/img/default.png') }}">
                                @else
                                    <img style="border: none;zoom:150%;object-fit: cover;"
                                        class="img-profile rounded-circle shadow"
                                        src="{{ asset('images/profile/' . Auth::user()->gambar) }}">
                                @endif
                            </a>
