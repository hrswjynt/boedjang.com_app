        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6><b>Daftar BPM</b></h6>
                    <a href="{{ route('bpm.create') }}" class="btn btn-success btn-sm add">
                        <i class="fa fa-plus"></i>
                        <span>Tambah BPM</span>
                    </a>
                </div>
                <div class="card-body">
                  ...
                  <div id="bpm-data">
                    <div class="table-responsive">
                        <table class="table" id="table-bpm-data" width="100%">
                            <thead>
                                <tr>
                                    <th>
                                        No
...
<script type="text/javascript">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if(data !== null){
                            return '<a target="__blank" href="'+base_url+'/bpm-list/'+row.slug+'">'+data+'</a>';
                        }else{
                            return '-';
                        }           
                    }
    ...
    $(document).ready(function () {
        $("body").on("click", ".bpmDelete", function (e) {
            e.preventDefault();
            var id = $(this).data("id");
            ...
            swal({
                ...
                text: 'BPM yang telah dihapus tidak dapat dikembalikan lagi!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function (value) {
                if (value) {
