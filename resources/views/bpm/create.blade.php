        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{route('bpm.store')}}" id="bpm_form" enctype="multipart/form-data">
                        @csrf
...
<script type="module">
    ...
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan menambah BPM?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Penambahan Data BPM Dibatalkan!", {
                  icon: "error",
                });
              }
            });
