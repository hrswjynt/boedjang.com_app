    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-body">
                    <!-- Search form -->
                    <form class="form-inline d-flex justify-content-center md-form form-sm active-cyan-2 mt-2" action="{{route('bpm_search.index')}}" method="GET" style="margin-bottom: 30px">
                         @csrf
                        <input class="form-control" type="text" aria-label="Search"name="search" placeholder="Cari BPM" value="{{$search}}" style="margin:5px"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            <div class="card mb-6 box-shadow" style="width: 100%">
                                ...
                                <div class="zoom2" style="width: 100%">
                                    <a href="{{url('bpm-list/'.$s->slug)}}" style="text-decoration: none;">
                                ...
                                <div class="zoom2" style="width: 100%">
                                    <a href="{{url('bpm-list/'.$s->slug)}}" style="text-decoration: none;">
                                        <img src="{{ asset('images/bpm/'.$s->gambar) }}" style="height: 200px;width: 100%;object-fit: cover;border-bottom: 1px solid #DFE4E5;">
                                    </a>
                                </div>
                                @endif
                                <div class="card-body">
                                    <div class="zoom"><a href="{{url('bpm-list/'.$s->slug)}}" style="text-decoration: none;"><h4 class="card-text text-gray-900" style="text-align: center;font-weight: 800;margin-bottom: 50px">{{$s->title}}</h4></a></div>
                        ...
                        <div class="col-md-12" style="height: 400px;">
                            <h3 style="text-align: center;margin-top: 30px">Tidak ada data BPM yang tersedia. <i class="fas fa-laugh-wink"></i></h3>
                        </div>
                        @endif
...
<div class="d-flex col-md-12">
    <div class="mx-auto">
        {{$bpm->appends(request()->input())->onEachSide(1)->links()}}
    </div>
</div>
