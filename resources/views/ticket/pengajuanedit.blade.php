        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 ">Manajemen Ticket <b>{{$ticket->code}}</b></h6>
                    <a href="{{ route('manajementicket.index') }}" class="btn btn-info btn-sm add">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{url('ticketupdate/'.$ticket->id)}}" id="ticket_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-4 bmd-form-group">
                                    ...
                                    <select class="select2" name="platform" id="platform" class="form-control" style="width: 100%">
