                                ...
                                <div class="card-body">
                                    <div class="col-md-6">
                                        <div class="form-group mb-4 bmd-form-group">
                                            ...
                                            @if ($user->gambar == null)
                                                <img id="img" src="{{ asset('admin/img/default.png') }}"
                                                    alt="your image"
                                            ...
                                            @else
                                                <img id="img" src="{{ asset('images/profile/' . $user->gambar) }}"
                                                    alt="your image"style="margin-top: 10px;margin-left: auto;margin-right: auto;width: 100%;max-width: 300px" />
                                            @endif
                                        </div>
                                        <div class="form-group mb-4 bmd-form-group">
                                            <label class="bmd-label-floating">Nama Pengguna <span
                                                    class="red">*</span></label>
                                            <input name="name" type="text" class="form-control"
                                                value="{{ $user->name }}" id="name" maxlength="100" disabled="">
                                        </div>
                                        <div class="form-group mb-4 bmd-form-group">
                                            <label class="bmd-label-floating">Username <span class="red">*</span></label>
                                            <input name="username" type="text" class="form-control"
                                                value="{{ $user->username }}" id="username" maxlength="20" disabled="">
                                        </div>
                                        <div class="form-group mb-4 bmd-form-group">
                                            <label class="bmd-label-floating">Email </label>
                                            <input name="email" type="email" class="form-control"
                                                value="{{ $user->email }}" maxlength="100" disabled="">
                                        </div>
                                        <div class="form-group mb-4 bmd-form-group">
