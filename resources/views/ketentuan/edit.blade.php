        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{route('ketentuan.update',$ketentuan->id)}}" id="ketentuan_form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-4 bmd-form-group">
                                        ...
                                        <input name="title" type="text"
                                            class="form-control" value="{{$ketentuan->title}}" tabindex="1" id="title" maxlength="200" >
                                    </div>
                                    <div class="form-group mb-4 bmd-form-group">
                                    ...
                                    <div class="form-group mb-4 bmd-form-group">
                                        ...
                                        <input name="sequence" type="number"
                                            class="form-control" value="{{$ketentuan->sequence}}" id="sequence" required="">
                                    </div>
                                    
                                    <div class="form-group mb-4 bmd-form-group">
                                        <label>Konten <span class="red">*</span></label>
                                        <textarea rows="5" name="content" id="konten" class="form-control" required="">{!! $ketentuan->content !!}</textarea>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan mengupdate Ketentuan?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                $("#ketentuan_form").submit()
              } else {
                swal("Proses Update Data Ketentuan Dibatalkan!", {
                  icon: "error",
                });
              }
            });
        ...
        $("#ketentuan_form").submit(function(){
            if($("#ketentuan_form").valid()){
                $('#btn-submit').hide();
        ...
        if($("#ketentuan_form").length > 0) {
            $("#ketentuan_form").validate({
                rules: {
                    title: {
                        required: true
                    },
