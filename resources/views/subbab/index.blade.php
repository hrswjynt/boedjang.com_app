        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6><b>Daftar Sub Bab</b></h6>
                    <a href="{{ route('subbab.create') }}" class="btn btn-success btn-sm add">
                ...
                <div class="card-body">
                  ...
                  <div id="subbab-data">
                    <div class="table-responsive">
                        <table class="table" id="table-subbab-data" width="100%">
                            <thead>
                                <tr>
                                    <th>
                                        No
...
<script type="text/javascript">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        // if(data !== null){
                        //     return '<a target="__blank" href="'+base_url+'/subbab-list/'+row.slug+'">'+data+'</a>';
                        // }else{
                        //     return '-';
                        // }
                        return data;           
    ...
    $(document).ready(function () {
        $("body").on("click", ".subbabDelete", function (e) {
            e.preventDefault();
            var id = $(this).data("id");
            ...
            swal({
                ...
                text: 'Sub Bab yang telah dihapus tidak dapat dikembalikan lagi!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function (value) {
                if (value) {
