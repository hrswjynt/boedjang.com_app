        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{route('asset.update',$asset->id)}}" id="asset_form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-4 bmd-form-group">
                                        ...
                                        <textarea rows="2" name="description" id="description" class="form-control" required="">{!! $asset->description !!}</textarea>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function(){
            swal({
                title: "Apakah anda yakin akan mengupdate Katalog Aset?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                ...
                swal("Proses Update Data Katalog Aset Dibatalkan!", {
                  icon: "error",
                });
              }
            });
